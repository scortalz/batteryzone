...
<div class="col-12 col-md-9 bodyContent">
    <p class="float-left d-md-none">
        <button type="button" class="btn btn-primary btn-sm menuButton" data-toggle="offcanvas">&DoubleLongLeftArrow; Toggle Categories</button>
    </p>
    ...
    <div>
      <img class="bannerUnder" src="<?php echo base_url();?>assets/images/sliderbanr.jpg">
    </div>
